...
import iswag from "../assets/iswagmain.jpg";
import { Footer } from "../components/footer";
...
export function LandingPage() {
  ...
  return (
    <div className="lg:absolute lg:left-[35%] lg:top-[12%] lg:w-[60%]">
      <div className="relative text-left border-b border-[#deab24] rounded-b-[20px] pt-[12%] lg:pt-[8%] lg:top-[25%]">
        <img
          src={iswag}
          alt="Fusion Grandeur"
          className="w-[100%]"
      ...
      <div className="flex justify-between p-2 px-[1.5rem] mb-[1rem] text-white bg-[#010101] font-bold rounded-[20px] heading">
        <h2>Mobile Phones & Laptops</h2>
        <p
          onClick={() => {
      ...
      <div className="flex font-bold justify-between p-2 px-[1.5rem] mb-[1rem] text-white bg-[#010101] rounded-[20px]">
        <h2>Accessories</h2>
        <p
          onClick={() => {
