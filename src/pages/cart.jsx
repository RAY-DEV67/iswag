          ...
          {!empty && (
            <div>
              ...
              <div onClick={() => {
                ...
                <button className="text-white rounded-[20px] bg-[#010101] font-bold mt-[2rem] py-[0.5rem] px-[1rem]">
                  Check Out
                </button>
              </div>
            </div>
          )}
          <p className="text-[#010101] lg:hidden text-center bg-[#ffffff] fixed text-[10px] w-[4%] left-[93%] top-[3%] z-20 rounded-full">
            {saved.length}
          </p>
        </div>
      ) : (
