...
import logo from "../assets/iswaglogo.png";
...
// console.log(user.u)
  ...
  return (
    <div className="flex flex-col ">
      ...
      <div className="fixed px-[1rem] w-[100%] navbar bg-[#010101] z-10">
        <div className="flex items-center justify-between">
          <div className="lg:w-[100vw] lg:flex lg:flex-col lg:items-center">
            <Link to="/">
            <img src={logo} alt="logo" className="w-[40%] py-[1rem] ml-[-1rem] lg:w-[300px]"/>
          </Link>
          </div>
